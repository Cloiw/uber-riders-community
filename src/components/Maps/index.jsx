  ...
  showPins() {
    ...
    if (this.active === true) {
      ...
      db.collection("pins").onSnapshot((querySnapshot) => {
        ...
        this.markers = this.state.pins.map(e => {
          const icon = {
          ...
          <div className="alcien">
            <Container fluid>
              ...
              <Row bsPrefix="row icons-bot">
                <img alt="Seguridad" id='security' onClick={() => this.togglePins()} className='icons' src={!this.active ? btnSeguridad : btnSeguridadActivo} />
